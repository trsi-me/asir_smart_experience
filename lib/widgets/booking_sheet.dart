...
class _BookingSheetContentState extends State<_BookingSheetContent> {
  ...
  void _confirmBooking() async {
    ...
    if (!AuthService().isLoggedIn) {
      await showRegisteredFeatureDialog(context, context.l10n.guestActionBlocked);
      return;
    }
    ...
    final bookingId = await DatabaseHelper.instance.addBooking(
    ...
    if (bookingId < 0) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.guestActionBlocked), backgroundColor: AppColors.rose),
      );
      return;
    }
