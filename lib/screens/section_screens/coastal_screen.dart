...
/// الساحل - القحمة والبرك
class CoastalScreen extends StatelessWidget {
  const CoastalScreen({super.key});
    ...
    return SectionScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ...PlacesData.coastalPlaces.map((p) {
  ...
  Widget _buildHeaderImage(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Image.network(
            proxiedImageUrl(AppImages.coastal),
            fit: BoxFit.cover,
          ...
          Positioned(left: 20, right: 20, bottom: 20, child: Text(context.l10n.aseerCoasts, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.white))),
        ],
      ),
    );
  }
