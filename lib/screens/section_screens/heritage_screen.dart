      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(l10n.verifiedPlacesTitle, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.teal)),
          ),
          const SizedBox(height: 12),
          ...AsirRealContent.byCategory('attractions').map((raw) {
