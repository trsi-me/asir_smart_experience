      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(context.l10n.verifiedPlacesTitle, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.teal)),
          ),
          const SizedBox(height: 12),
          ...AsirRealContent.byCategory('farms').map((raw) {
