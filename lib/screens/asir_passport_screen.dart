...
class _AsirPassportScreenState extends State<AsirPassportScreen>
        ...
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  context.l10n.passportLoginMessage,
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: AppColors.white80, fontSize: 16, height: 1.5),
                ),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () => Navigator.push(
                          context,
                          AppTransitions.fadeScale(const UnifiedAuthScreen(initialTab: 0)),
                        ),
                    ...
                    Expanded(
                      child: FilledButton(
                        onPressed: () => Navigator.push(
                          context,
                          AppTransitions.fadeScale(const UnifiedAuthScreen(initialTab: 1)),
                        ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(child: Text(context.l10n.passportLinkedOnly, style: const TextStyle(color: AppColors.white80, height: 1.45))),
            ],
          ),
        ),
        const SizedBox(height: 16),
  ...
  void _showAddStampDialog() {
    ...
    ].where((p) => PassportStampPolicy.approvedPlaceIds.contains(p['id'] as String)).toList();
